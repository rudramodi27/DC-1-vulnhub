...
- Provide step-by-step walkthrough (commands + screenshots).
- Include exported scan outputs, helper scripts, and PoC exploit code (if applicable).
- Teach methodology: how to find and confirm vulnerabilities safely.
